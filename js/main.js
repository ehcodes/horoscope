...
function createHoroscope(){
  ...
  if((month == 12 && day >= 22) || (month == 1 && day <=19)) {
		document.getElementsByTagName('h1')[0].innerHTML ='Capricorn';
    document.getElementsByTagName('h2')[0].innerHTML ='December 22-January 19';
   ...
   document.getElementsByTagName('h1')[0].innerHTML ='Aquarius';
   document.getElementsByTagName('h2')[0].innerHTML ='January 20 to February 18';
   ...
   document.getElementsByTagName('h1')[0].innerHTML ='Pisces';
   document.getElementsByTagName('h2')[0].innerHTML ='February 19 to March 20';
   ...
   document.getElementsByTagName('h1')[0].innerHTML ='Aries';
   document.getElementsByTagName('h2')[0].innerHTML ='March 21-April 19';
   ...
   document.getElementsByTagName('h1')[0].innerHTML ='Taurus';
   document.getElementsByTagName('h2')[0].innerHTML ='April 20-May 20';
   ...
   document.getElementsByTagName('h1')[0].innerHTML ='Gemini';
   document.getElementsByTagName('h2')[0].innerHTML ='May 21-June 20';
   ...
   document.getElementsByTagName('h1')[0].innerHTML ="Cancer"
   document.getElementsByTagName('h2')[0].innerHTML ='June 21-July 22';
   ...
   document.getElementsByTagName('h1')[0].innerHTML ="Leo";
   document.getElementsByTagName('h2')[0].innerHTML ='July 23-August 22';
   ...
   document.getElementsByTagName('h1')[0].innerHTML ="Virgo";
   document.getElementsByTagName('h2')[0].innerHTML ='August 23-September 22';
   ...
   document.getElementsByTagName('h1')[0].innerHTML ="Libra";
   document.getElementsByTagName('h2')[0].innerHTML ='September 23-October 22';
   ...
   document.getElementsByTagName('h1')[0].innerHTML ="Scorpio";
   document.getElementsByTagName('h2')[0].innerHTML ='October 23-November 21';
   ...
   document.getElementsByTagName('h1')[0].innerHTML = "Sagittarius";
   document.getElementsByTagName('h2')[0].innerHTML ='November 22-December 21';
   document.getElementsByTagName('p')[0].innerHTML ="Today you could feel especially intuitive and more sensitive than usual to unacceptable social and political conditions, Sagittarius. Ideas for new goals, perhaps humanitarian, might come to you. You should be in an especially idealistic mood, so you might come up with wonderful possibilities that aren't workable now. Write your ideas down and consult with someone who shares your interests. Then decide how to proceed.";
    ...
    document.getElementsByTagName('h1')[0].innerHTML ='Invalid Date';
    document.getElementsByTagName('h2')[0].innerHTML ='Please select your birthday.';
}
}
